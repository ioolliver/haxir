defmodule Haxir.Api do
    ...
    **Examples**
    ```elixir
      iex> Haxir.Api.send_announcement("Hello, Haxir!")
      "Hello, Haxir!"
    ```
  """
  ...
  @doc """
    ...
    * `:allow_mentions` (boolean) - If false, then message's mentioned players will not see the message bold and with notification sound. Default is true.
    ...
    ## Examples
      ...
      iex> Haxir.Api.send_announcement("Hello!", color: 0xFF0000, style: "bold")
      "Hello!"

      iex> Haxir.Api.send_announcement("Will not ping", allow_mentions: false)
      "Will not ping"

      iex> Haxir.Api.send_announcement("Only player with ID 2 will receive the message", targets: 2)
      "Only player with ID 2 will receive the message"

      iex> Haxir.Api.send_announcement("Only player with ID 1 and my_player will receive the message", targets: [1, my_player])
      "Only player with ID 1 and my_player will receive the message"
  """
  @spec send_announcement(String.t(), Enum.t()) :: String.t()
  def send_announcement(content, opts \\ []) do
  ...
  @doc """
    ...
    # Examples
      ...
      iex> Haxir.Api.game_ocorring?()
      true
  """
  @spec game_ocorring?() :: boolean()
  def game_ocorring?() do
    case Haxir.RoomState.get_game_ocorring() do
      true -> true
      _ -> false
    end
  end
  ...
  @doc """
    ...
    # Examples
      ...
      iex> Haxir.Api.game_paused?()
      false
  """
  @spec game_paused?() :: boolean()
  def game_paused?() do
    case Haxir.RoomState.get_game_paused() do
      true -> true
      _ -> false
    end
  end
