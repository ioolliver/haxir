defmodule Haxir.Api do
  ...
  def set_stadium("classic"),
    do:
      Haxir.Socket.send_data(%{message: "set_default_stadium", args: %{stadium_name: "Classic"}})

  def set_stadium("easy"),
    do: Haxir.Socket.send_data(%{message: "set_default_stadium", args: %{stadium_name: "Easy"}})

  def set_stadium("small"),
    do: Haxir.Socket.send_data(%{message: "set_default_stadium", args: %{stadium_name: "Small"}})

  def set_stadium("big"),
    do: Haxir.Socket.send_data(%{message: "set_default_stadium", args: %{stadium_name: "Big"}})

  def set_stadium("rounded"),
    do:
      Haxir.Socket.send_data(%{message: "set_default_stadium", args: %{stadium_name: "Rounded"}})

  def set_stadium("hockey"),
    do: Haxir.Socket.send_data(%{message: "set_default_stadium", args: %{stadium_name: "Hockey"}})

  def set_stadium("big_hockey"),
    do:
      Haxir.Socket.send_data(%{
        message: "set_default_stadium",
        args: %{stadium_name: "Big Hockey"}
      })

  def set_stadium("big_easy"),
    do:
      Haxir.Socket.send_data(%{message: "set_default_stadium", args: %{stadium_name: "Big Easy"}})

  def set_stadium("big_rounded"),
    do:
      Haxir.Socket.send_data(%{
        message: "set_default_stadium",
        args: %{stadium_name: "Big Rounded"}
      })

  def set_stadium("huge"),
    do: Haxir.Socket.send_data(%{message: "set_default_stadium", args: %{stadium_name: "Huge"}})
